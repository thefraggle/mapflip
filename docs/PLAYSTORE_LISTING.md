# MapFlip – Play Store Listing

## App-Name
**MapFlip – Apple Maps to Google Maps**
...
|---|---|---|
| 🇩🇪 DE | Apple Maps Links automatisch in Google Maps öffnen. | 52 |
| 🇬🇧 EN | Automatically open Apple Maps links in Google Maps. | 52 |
...
|---|---|
| **Kategorie** | Tools |
| **Tags** | Maps, Navigation, Converter, Apple Maps, Google Maps |
| **Content Rating** | Everyone / USK 0 |
| **Preis** | Kostenlos |
| **Werbung** | Nein |
| **In-App-Käufe** | Nein |
...
| # | Inhalt | Beschriftung DE | Beschriftung EN |
|---|---|---|---|
| 1 | Setup-Screen mit Animation | Einmal einrichten, dann automatisch | Set up once, then automatic |
| 2 | Setup-Schritte (Card) | 3 einfache Schritte | 3 simple steps |
| 3 | Status: Links aktiviert ✅ | Bereit! Links werden umgeleitet | Ready! Links are redirected |
| 4 | Apple Maps Link → Google Maps | Vorher/Nachher Vergleich | Before/After comparison |

---

## Store Listing Kontakt
